package SerialPort; # test and install only
#### package Win32::SerialPort;

use Win32;
use CommPort qw( :STAT :PARAM 0.12 );	# test and install only
...
@ISA = qw( Exporter CommPort ); # test and install only
...
@EXPORT= qw();
@EXPORT_OK= @CommPort::EXPORT_OK;      # test and install only
%EXPORT_TAGS = %CommPort::EXPORT_TAGS; # test and install only
...
sub set_test_mode_active {
    CommPort->set_no_messages; # test and install only
